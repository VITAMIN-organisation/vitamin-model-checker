...
_lr_productions = [
    ...
    ("quantifiers -> quantifier", "quantifiers", 1, "p_quantifiers", "parser.py", 82),
    (
    ...
    ("opt_bound -> BOUND", "opt_bound", 1, "p_opt_bound", "parser.py", 97),
    ("opt_bound -> empty", "opt_bound", 1, "p_opt_bound", "parser.py", 98),
